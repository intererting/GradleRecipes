 ...
 */
package com.example.normal.apk
...
abstract class CopyApksTask @Inject constructor(private val workers: WorkerExecutor) :
    ...
    fun taskAction() {
        ...
        println("-================================-")
        println(apkFolder.get().asFile.absolutePath)
        println(outFolder.get().asFile.absolutePath)
        println("-================================-")
        transformationRequest.get().submit(
            ...
            println("-================================-")
            println(builtArtifact.outputFile)
            println(outputLocation.asFile.absolutePath)
            println("-================================-")
